...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till CscpAssist..."),
        ...
        ("install_tip", "På grund av UAC, kan inte CscpAssist fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera CscpAssist på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge CscpAssist \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge CscpAssist \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [CscpAssist Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep CscpAssist background service", "Behåll CscpAssist i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa CscpAssist programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
        ...
        ("Show CscpAssist", "Visa CscpAssist"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
