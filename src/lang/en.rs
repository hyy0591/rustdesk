...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the CscpAssist network..."),
        ...
        ("install_tip", "Due to UAC, CscpAssist can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install CscpAssist to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant CscpAssist \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant CscpAssist \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow CscpAssist to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [CscpAssist Input] service."),
        ...
        ("doc_mac_permission", "https://assist.cscp.psbc.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next CscpAssist application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant CscpAssist \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant CscpAssist \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running CscpAssist."),
        ...
        ("verify_rustdesk_password_tip", "Verify CscpAssist password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use CscpAssist and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade CscpAssist Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://assist.cscp.psbc.com/docs/en/client/linux/#x11-required"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent CscpAssist from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by CscpAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if CscpAssist window is open"),
        ...
        ("floating_window_tip", "It helps to keep CscpAssist background service"),
    ].iter().cloned().collect();
}
