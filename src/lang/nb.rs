...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til CscpAssist-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan CscpAssist ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere CscpAssist på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Click to download", "Klikk for å laste ned"),
        ("Click to update", "Klikk for å oppdatere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi CscpAssist \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi CscpAssist \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi CscpAssist mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [CscpAssist Input] tjenesten."),
        ...
        ("Turned off", "Avslått"),
        ("Language", "Språk"),
        ("Keep CscpAssist background service", "Behold CscpAssist baggrundstjeneste"),
        ...
        ("Show CscpAssist", "Vis CscpAssist"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
