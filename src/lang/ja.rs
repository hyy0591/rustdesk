...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "CscpAssistがUACの影響によりリモート側で正常に動作しない場合があります。UACを回避するには、下のボタンをクリックしてシステムにCscpAssistをインストールしてください。"),
        ("Click to upgrade", "アップグレード"),
        ("Click to download", "ダウンロード"),
        ("Click to update", "アップデート"),
        ("Configure", "設定"),
        ("config_acc", "リモートからあなたのデスクトップを操作するには、CscpAssistに「アクセシビリティ」権限を与える必要があります。"),
        ("config_screen", "リモートからあなたのデスクトップにアクセスするには、CscpAssistに「画面収録」権限を与える必要があります。"),
        ("Installing ...", "インストール中..."),
        ("Install", "インストール"),
        ("Installation", "インストール"),
        ...
        ("android_input_permission_tip1", "このAndroid端末をリモートの端末からマウスやタッチで操作するには、CscpAssistに「アクセシビリティ」サービスの使用を許可する必要があります。"),
        ...
        ("Turned off", "オフになりました"),
        ("Language", "言語"),
        ("Keep CscpAssist background service", "CscpAssist バックグラウンドサービスを維持"),
