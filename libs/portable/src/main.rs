...
const APP_PREFIX: &str = "cscpassist";
const APPNAME_RUNTIME_ENV_KEY: &str = "CSCPASSIST_APPNAME";
...
mod windows {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_cscpassist.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &PathBuf) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_cscpassist.exe"])
