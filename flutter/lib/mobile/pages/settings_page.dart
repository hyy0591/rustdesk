...
const url = 'https://assist.cscp.psbc.com/';
      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep CscpAssist background service')),
          ...
          tiles: [
            SettingsTile(
                ...
                value: Padding(
                  ...
                  child: Text('assist.cscp.psbc.com',
                      style: TextStyle(
            ...
            SettingsTile(
              ...
              onPressed: (context) =>
                  launchUrlString('https://assist.cscp.psbc.com/privacy.html'),
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text('${translate('About')} CscpAssist'),
