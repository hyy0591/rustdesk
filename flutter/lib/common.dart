...
void msgBox(SessionID sessionId, String type, String title, String text,
  ...
  submit() {
    dialogManager.dismissAll();
    // https://github.com/rustdesk-org/rustdesk/blob/5e9a31340b899822090a3731769ae79c6bf5f3e5/src/ui/common.tis#L263
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing CscpAssist...");
...
Widget loadPowered(BuildContext context) {
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://assist.cscp.psbc.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
